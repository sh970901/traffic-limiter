...
public class LimiterService {
    ...
    private boolean inActiveRoom(String userId){
        return Boolean.TRUE.equals(activeRoomService.isActiveUser(userId).block());
    }


    private boolean inWaitingRoom(String userId){
        return Boolean.TRUE.equals(waitingRoomService.isExistWaitingUser().block());
    }
